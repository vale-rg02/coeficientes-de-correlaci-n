...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        double correlacionProfitRD = calcularCorr(profit, rdSpend);
        double correlacionProfitMarketing = calcularCorr(profit, marketingSpend);

        System.out.println("Coeficiente de correlación entre R&D Spend y Profit: " + correlacionProfitRD);
        System.out.println("Coeficiente de correlación entre Marketing Spend y Profit: " + correlacionProfitMarketing);
    }

    private static double calcularCorr(ArrayList<Double> x, ArrayList<Double> y) {
